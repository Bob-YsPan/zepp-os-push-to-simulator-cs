...
3. Supports the zip package that exports by SashaCX75's watchface editor, just open it by the convert method!
4. This project requires a minimum of .NET Framework 4.7.2 and is built using Visual Studio 2026.
5. See the [Releases](../../releases) to downloads the pre-built package!
